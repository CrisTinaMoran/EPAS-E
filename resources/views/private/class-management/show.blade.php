                        ...
                        <div class="d-flex align-items-center">
                            @php
                                $adviserInitials = strtoupper(
                                    substr($currentAdviser->first_name ?? '', 0, 1) . 
                                    substr($currentAdviser->last_name ?? '', 0, 1)
                                );
                                $adviserAvatar = $currentAdviser->profile_image 
                                    ? secure_asset('storage/profile-images/' . $currentAdviser->profile_image)
                                    : "https://ui-avatars.com/api/?name={$adviserInitials}&background=28a745&color=fff&size=48";
                            @endphp
                            <img src="{{ $adviserAvatar }}" alt="Adviser Avatar" class="rounded-circle me-3" width="48" height="48">
                            <div>
