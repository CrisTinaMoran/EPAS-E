        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <span class="badge bg-info ms-2">
                    Total Students: {{ $sectionFilter ? ($students->total() ?? 0) : array_sum(array_map('count', $studentsBySection)) }}
                </span>
            </div>
        </div>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $avatarUrl = $student->profile_image 
                                                    ? secure_asset('storage/profile-images/' . $student->profile_image)
                                                    : "https://ui-avatars.com/api/?name={$initials}&background=007fc9&color=fff&size=32";
                                            @endphp
                                            <img src="{{ $avatarUrl }}" alt="User Avatar" class="rounded-circle" width="32" height="32">
                                        </td>
                                ...
                                @if($sectionAdviser)
                                    <div class="adviser-info mb-3 p-2 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            @php
                                                $adviserInitials = strtoupper(
                                                    substr($sectionAdviser->first_name ?? '', 0, 1) . 
                                                    substr($sectionAdviser->last_name ?? '', 0, 1)
                                                );
                                                $adviserAvatar = $sectionAdviser->profile_image 
                                                    ? secure_asset('storage/profile-images/' . $sectionAdviser->profile_image)
                                                    : "https://ui-avatars.com/api/?name={$adviserInitials}&background=28a745&color=fff&size=32";
                                            @endphp
                                            <img src="{{ $adviserAvatar }}" alt="Adviser Avatar" class="rounded-circle me-2" width="32" height="32">
