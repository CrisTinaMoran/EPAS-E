                                                    ...
                                                    <div id="infoSheetCollapse{{ $infoSheet->id }}" class="accordion-collapse collapse" 
                                                        ...
                                                        <div class="accordion-body bg-white border rounded">
                                                            ...
                                                            <div class="content-items">
                                                                ...
                                                                <!-- Add Content Section -->
                                                                <div class="add-content-section p-4 bg-light rounded border">
                                                                    <h5 class="text-success mb-3">
                                                                        <i class="fas fa-plus-circle me-2"></i>Add New Content
                                                                    </h5>
                                                                    <div class="d-grid gap-2 d-md-flex flex-wrap">
                                                                        <a href="{{ route('topics.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Topic
                                                                        </a>
                                                                        <a href="{{ route('self-checks.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Self-Check
                                                                        </a>
                                                                        <a href="{{ route('task-sheets.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Task Sheet
                                                                        </a>
                                                                        <a href="{{ route('job-sheets.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Job Sheet
                                                                        </a>
                                                                        <a href="{{ route('homeworks.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Homework
                                                                        </a>
                                                                        <a href="{{ route('performance-criteria.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Performance Criteria
                                                                        </a>
                                                                        <a href="{{ route('checklists.create', $infoSheet->id) }}" class="btn btn-outline-success">
                                                                            <i class="fas fa-plus me-1"></i>Add Check List
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
