...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Remove the old event listener that was causing the error
    // The link should now work normally with the href attribute
    ...
    if (forgotPasswordLink) {
        forgotPasswordLink.addEventListener('click', function(e) {
            ...
            // The default behavior (navigation) will happen automatically
        });
    }
});
